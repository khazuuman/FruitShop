<%-- 
    ...
    Created on : Feb 22, 2024, 11:40:36 PM
    Author     : MM
--%>
...
<!--        <link rel="stylesheet" href="./css/Home/grid.css"/>-->
    ...
    <body class="hold-transition skin-blue sidebar-mini">
        ...
        <div class="row">
            ...
            <div class="col-10">
                <form action="editslider" method="post" style="margin:20px;left: 20%;position: absolute;">

                    <ul class="slider-detail">
                        <li class="slider-item">
                            <span class="slider-item-left">ID</span>
                            <span class="slider-item-right"><input type="text" readonly="" value="${slider.getSliderID()}" name="id"></span>
                        </li>
                        <li class="slider-item">
                            <span class="slider-item-left">Title</span>
                            <span class="slider-item-right">
                                <textarea rows="4" cols="22" name="content">${slider.getContent()}</textarea>
                            </span>
                        </li>
                        <li class="slider-item">
                            <span class="slider-item-left">Image</span>
                            <span class="slider-item-right">
                                <input type="file" id="uploadInput" accept="image/*" onchange="previewImage(event)" name="img" value="${slider.getSliderImg()}">
                                <img id="preview" style="width: 50%; margin-top: 20px;" src="./img/${slider.getSliderImg()}">
                            </span>
                        </li>

                        <li class="slider-item">

                            <c:if test="${slider.getIsActive() == 1}">
                            ...
                            <c:if test="${slider.getIsActive() == 0}">
                                <span class="slider-item-left">Status</span>
                        ...
                        <li class="slider-item">
                            ...
                            <span class="slider-item-right"><input type="text" value="${slider.getProduct().getProductID()}" name="pid"></span>
                        </li>
