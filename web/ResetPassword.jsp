...
<%@ page import="controller.ForgotPasswordController" %>

<%
String token = request.getParameter("token");

if (token != null && ForgotPasswordController.isTokenValid(token)) { %>
<!DOCTYPE html>
<html>
    <head>
        <!--<meta charset="UTF-8" />-->
    ...
    <body>
        <section class="container">
            ...
            <form action="ResetPasswordController" method="post" class="form">
                ...
                <div class="input-box">
                    ...
                    <h3 class="error" style="color: red;">${msg} </h3>    
