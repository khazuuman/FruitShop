    ...
    <body class="hold-transition skin-blue sidebar-mini">
        ...
        <div class="row">
            ...
            <div class="col-lg-10 main-content">
                ...
                <form class="form-area " action="ManagerBlogDetail" method="post">
                    <div class="half-col">
                        <label for="title" class="form-label">ID:</label>
                        <input type="text" id="title" name="blogId" readonly="" value="${b.blogID}"  class="form-control" required>
                    </div>
                    <div class="half-col">
                        <label for="title" class="form-label">Title:</label>
                        <input type="text" id="title" name="title" value="${b.title}"  class="form-control" required>
                    </div>

                    <div class="half-col">
                        <label for="accountId" class="form-label">Author:</label>
                        <input type="hidden" id="title" name="accountId" value="${b.account.accID}" class="form-control" readonly="">

                        <input type="text" id="title" name="accountName" value="${b.account.username}" class="form-control" readonly="">
                    </div>
                    ...
                    <div class="half-col">
                        ...
                        <select id="categoryId" name="categoryId" class="form-select">
                            <c:forEach items="${bc}" var="rl">
                                <option value="${rl.blogCateID}" ${b.category.blogCateID==rl.blogCateID?"Selected":""}>${rl.blogCateName}</option>
                            </c:forEach>
                        </select>
                    </div>
                    ...
                    <div class="half-col">
                        ...
                        <select id="isActive" name="isActive" class="form-select">
                            <option value="true" ${b.isActive==true?"Selected":""}>Yes</option>
                            <option value="false" ${b.isActive==false?"Selected":""}>No</option>
                        </select>
                    </div>

                    <div class="full-col">
                        <label for="img" class="form-label">Image URL:</label>
                        <input type="text" id="img" name="img" value="${b.img}" class="form-control" required>
                    </div>

                    <div class="full-col">
                        <label for="content" class="form-label">Content:</label>
                        <textarea id="content" name="content"  rows="6" class="form-control" required>${b.content}</textarea>
                    </div>
